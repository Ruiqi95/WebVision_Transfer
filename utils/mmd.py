...
def rbf_mmd2(X, Y, shape_source, shape_target, sigma=1, biased=True):
    return mix_rbf_mmd2(X, Y, shape_source, shape_target, sigmas=[sigma], biased=biased)


def mix_rbf_mmd2(X, Y, shape_source, shape_target, sigmas=(1,), wts=None, biased=True):
    K_XX, K_XY, K_YY, d = _mix_rbf_kernel(X, Y, sigmas, wts)
    return _mmd2(K_XX, K_XY, K_YY, shape_source, shape_target, const_diagonal=d, biased=biased)
...
def _mmd2(K_XX, K_XY, K_YY, shape_source, shape_target, const_diagonal=False, biased=False):
